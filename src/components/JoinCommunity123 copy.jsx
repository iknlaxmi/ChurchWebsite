...
const JoinCommunity123 = () => {
  ...
  const nextSteps = [
    "Visit Us This Sunday at 10:00 AM",
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-semibold text-gray-800">Pastor John Doe</p>
                  <p className="text-gray-600">pastor@jeevanmargchurch.org</p>
                </div>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    123 Church Street, Bengaluru, Karnataka
                  </p>
                </div>
              </div>
            </div>
...
export default JoinCommunity123;
